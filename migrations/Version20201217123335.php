 ...
 */
final class Version20201217123335 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE abonnements_id abonnement_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE abonnement_id abonnements_id INT DEFAULT NULL');
